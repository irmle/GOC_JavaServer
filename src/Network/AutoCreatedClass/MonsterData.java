...
public class MonsterData {
    ...
    public MonsterData(flat_MonsterData data) {
        this.entityID = data.entityID();
        this.team = data.team();
        this.monsterType = data.monsterType();
        this.monsterLevel = data.monsterLevel();
        this.monsterElemental = data.monsterElemental();
        ...
        this.lookRadius = data.lookRadius();
    ...
    public static MonsterData createMonsterData(byte[] data)
    {
        return flat_MonsterData.getRootAsflat_MonsterData( data );
    }

    public static byte[] getBytes(MonsterData data)
    {
        return flat_MonsterData.createflat_MonsterData( data );
    }

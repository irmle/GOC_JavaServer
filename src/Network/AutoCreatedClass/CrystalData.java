...
public class CrystalData {
    ...
    public CrystalData(flat_CrystalData data) {
        this.entityID = data.entityID();
        this.team = data.team();
        this.crystalLevel = data.crystalLevel();
    ...
    public static CrystalData createCrystalData(byte[] data)
    {
        return flat_CrystalData.getRootAsflat_CrystalData( data );
    }

    public static byte[] getBytes(CrystalData data)
    {
        return flat_CrystalData.createflat_CrystalData( data );
    }

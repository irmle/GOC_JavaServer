...
public final class flat_LoadingPlayerData extends Table {
  ...
  public int guardianID() { int o = __offset(6); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  ...
  public float currentProgressPercentage() { int o = __offset(12); return o != 0 ? bb.getFloat(o + bb_pos) : 0.0f; }
  ...
  public static int createflat_LoadingPlayerData(FlatBufferBuilder builder,
    ...
    flat_LoadingPlayerData.addGuardianID(builder, guardianID);
    flat_LoadingPlayerData.addTokenID(builder, tokenIDOffset);
    return flat_LoadingPlayerData.endflat_LoadingPlayerData(builder);
  }

  public static void startflat_LoadingPlayerData(FlatBufferBuilder builder) { builder.startObject(5); }
  public static void addTokenID(FlatBufferBuilder builder, int tokenIDOffset) { builder.addOffset(0, tokenIDOffset, 0); }
  public static void addGuardianID(FlatBufferBuilder builder, int guardianID) { builder.addInt(1, guardianID, 0); }
  ...
  public static void addCurrentProgressPercentage(FlatBufferBuilder builder, float currentProgressPercentage) { builder.addFloat(4, currentProgressPercentage, 0.0f); }
 ...
 LoadingPlayerData data) {
        ...
        return createflat_LoadingPlayerData(builder , tokenIDOffset, data.guardianID, data.characterType, characterNameOffset, data.currentProgressPercentage);
    }

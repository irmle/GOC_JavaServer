...
public class Logic_pickSelectedCharacter {
    ...
    public static void RMI_Packet(RMI_ID rmi_id, short rmi_ctx, String googleIDToken, int characterType, int guardianID)
    {
        //유저가 캐릭터를 선택하였다면
        ...
        {
            gameSessionRoom.userOnSelectedCharacter( googleIDToken, characterType, guardianID);
        }
    }
}